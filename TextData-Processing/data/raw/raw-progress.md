...
| 3 | **Grantham** | ✅ 수집 완료 | 2007~2026 (20y, gap 2016만) | 분기 letter + 시그니처 essay | PDF(gmo.com + Wayback) | 75 | 38 MB |
| 4 | **Driehaus** | ✅ 수집 완료 | 1996~2025 (30y) | 반기 (N-CSR/N-CSRS) | HTML/TXT(EDGAR) | 65 | 142 MB |
| 5 | **Einhorn** | ⚠️ 부분 수집 | 2012-2024 (시그니처/proxy 위주) | 비정형 (Sohn/Robin Hood 발표 + activist letter) | HTML(EDGAR) + PDF(Wayback) | 28 | 248 MB |
...
**Aggregate**: 544 파일 / ~910 MB (전체 7명 수집 완료, collision suffix → sequence 정규화 완료)

> **확장 이력**: 1차 379 → 487 → 526 → 520 → 518 → 544 파일
> - Grantham 26 → 38 → 75 (gmo.com brute-force + Wayback Machine archive)
> - Einhorn 2 → 28 (greenlightcapital.com 자체 도메인 Wayback fallback)
...
**분기 native + 시그니처 essay**. 최종 75 PDF.
...
| 2016 | Q3, Q4 | — | **Q1, Q2 누락 (sfvrsn=32 archive truncated, 영구 손실 가능)** |
| 2017 | Q1, Q2, Q3, Q4 | `stalin` | full + 시그니처 |
| 2018 | Q1, Q2, Q4 | — | **Q3 GMO 비발행** (research-library archive 검증) |
| 2019 | Q1, Q2, Q3 | — | **Q4 GMO 비발행** |
| 2020 | Q1, Q2, Q3 | — | **Q4 GMO 비발행** |
| 2021 | Q1, Q2, Q3, Q4 | — | full |
| 2022 | Q1, Q2, Q3, Q4 | — | full |
| 2023 | Q1, Q3, Q4 | — | **Q2 GMO 비발행** |
...
GMO `/americas/research-library/` 페이지의 archive.org 스냅샷 (2017-2024) 에서 letter landing slug 전수 조사:
- 2018 Q3, 2019 Q4, 2020 Q4, 2023 Q2: **landing page 자체가 archive 에 없음** → GMO 비발행 분기로 결론
- 즉 1년 4분기 cadence 가 GMO의 발간 정책이 아니며, mid-year letter / 시그니처 essay 로 대체된 분기들

### 저장 위치
[data/raw/grantham/](grantham/) — 75 PDF, 38 MB
...
```
Buffett                  48 files (HTML 1977-1997 + PDF 1998-2024)              8.9  MB  1977-2024
Hawkins                 125 files (57 site PDF + 68 EDGAR)                     82    MB  1995-2026
Grantham                 75 files (38 sitemap+brute + 37 Wayback fallback)     38    MB  2007-2026
Driehaus                 65 files (HTML/TXT EDGAR)                            142    MB  1996-2025
Einhorn                  28 files (2 GLRE 8-K + 26 greenlightcapital Wayback) 248    MB  2012-2024
...
3. ~~**Grantham gap 보완**~~ ✅ Wayback Machine 으로 2007-2017 거의 전체 메움 (38 → 75 PDF). 잔여 갭 (2016 Q1-Q2, 2018 Q3, 2019 Q4, 2020 Q4, 2023 Q2) 은 GMO 비발행 분기 또는 Wayback archive 손상으로 영구 손실
