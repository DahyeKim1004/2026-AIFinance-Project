...
| 3 | Macro-Value Allocator | Jeremy Grantham | Grantham Mayo Van Otterloo (GMO) (1352662) | 2006~ (20y) | [gmo.com 분기 letter](https://www.gmo.com/americas/research-library/) (2010~ archive PDF 직접) + Grantham 시그니처 에세이(연 1-2회) + GMO 7-Year Forecast | ⭐⭐⭐⭐⭐ | USMV, VLUE, MOAT, AOA |
| 4 | Momentum / Trend | Richard Driehaus | Driehaus Capital Mgmt (938206) | 1999~ (27y) | [driehaus.com 분기 commentary](https://www.driehaus.com/insights) | ⭐⭐⭐ | MTUM, PDP |
| 5 | Long/Short Fundamental | David Einhorn | Greenlight Capital (1079114) | 2000~ (24y) | [hedgefundalpha.com](https://hedgefundalpha.com) 등 third-party archive (분기 letter) | ⭐⭐⭐⭐ | BTAL, QLS |
| 6 | Disruptive Growth | Ron Baron | Baron Capital/BAMCO (1017918) | 2000~ (25y) | [baronfunds.com 분기 letter](https://www.baronfunds.com/insights/quarterly-reports) + Baron Investment Conference | ⭐⭐⭐⭐⭐ | ARKK, QQQ |
| 7 | Dividend Growth | Don Yacktman | Yacktman Asset Mgmt (874118) | 1992~ (30y) | [yacktman.com 반기 letter](https://www.yacktman.com) + Yacktman Focused Fund commentary | ⭐⭐⭐ | SCHD, VIG, NOBL |
...
### 원칙 2 — 카테고리 직교성 (7개 결이 겹치지 않게)
- **Value 두 결**: Quality Compounder(Buffett) ↔ Deep Value Contrarian(Hawkins)
- **Macro-Value Allocator**: Grantham — Top-down 자산배분 + Bubble 식별. Hawkins(bottom-up 종목 선정)와 분석 단위 다름. Dalio(Risk-Parity)·Druckenmiller(Discretionary)는 분기 letter 부재로 제외
...
v2 GRU의 분기 입력과 정렬 가능해야 함. 분기 letter 가 native 가 아닌 경우 carry-forward 또는 인접 cadence (반기/연간) 의 chunk 를 분기 슬롯에 배치 (§6 Cadence 노트 참조).
...
- 일반 대중 5/5: Buffett, Grantham, Baron
...
| **Stanley Druckenmiller** | 분기 letter 완전 부재. Duquesne Family Office 로 전환 후 LP letter 없음. Sohn 연 1회 + CNBC 인터뷰로는 GRU 학습용 분기 시계열 구성 불가 |
| **Ray Dalio (Bridgewater)** | 분기 letter 부재. Substack(2026 신규, 12편)·Bridgewater R&I(2022~ Co-CIO 저자)·LinkedIn(208편 비정형) 모두 2006~2021 공백 또는 본인 저술 아님. Grantham 으로 교체 |
...
| Grantham (GMO) | **분기 letter** (2010~) + Grantham 시그니처 essay (연 1-2회) + GMO 7-Year Forecast (분기) | 분기 native, 시그니처 essay 는 별도 source_type |
...
- `source_type` 확장 어휘:
  ...
  - `signature_essay` (Grantham 시그니처 essay 등)
  - `book_excerpt`
...
└── TextData-Processing/                        ← Role 1 네임스페이스
    ...
    │
    ├── data/
    │   ├── investors.csv                       (committed) 7명 메타데이터 단일 진실 소스
    │   │
